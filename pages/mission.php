...
<html lang="fr">
    ...
    <body>
        ...
        <div class="paragraphe">
            <img class="avion" src="../illustration/avion-decolle.jpg" alt="Un avion qui décolle">
        ...
        <div class="paragraphe">
            ...
            <img class="bar" src="../illustration/bar.jpg" alt="Bar">
        </div>
        <hr/>
        <div class="equipe">
            <ul class="liste-membres">
                <li class="membre">
                    <img class="photo-quentin" src="../decoration/profil.jpg" alt="Photo de Quentin">
                    <h4 class="nom">Quentin Meignan</h4>
                    <p class="mail">quentin.meignan@gmail.com</p>
                </li>
                <li class="membre">
                    <img class="photo-loris" src="../decoration/profil.jpg" alt="Photo de Loris">
                    <h4 class="nom">Loris Ponroy</h4>
                    <p class="mail">loris.ponroy@gmail.com</p>
                </li>
                <li class="membre">
                    <img class="photo-florian" src="../decoration/profil.jpg" alt="Photo de Florian">
                    <h4 class="nom">Florian Landry</h4>
                    <p class="mail">florian.landry@gmail.com</p>
                </li>
                <li class="membre">
                    <img class="photo-alexandre" src="../decoration/profil.jpg" alt="Photo de Alexandre">
