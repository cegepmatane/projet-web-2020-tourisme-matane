...
<html lang="fr">
    ...
    <body>
        ...
        <div class="paragraphe">
            <img id="avion" src="../illustration/avion-decolle.jpg" alt="Un avion qui décolle">
        ...
        <div class="paragraphe">
            ...
            <img id="bar" src="../illustration/bar.jpg" alt="Bar">
        </div>
        <hr/>
        <div id="equipe">
            <ul id="liste-membres">
                <li class="membre">
                    <img class="photo" src="../decoration/profil.jpg" alt="Photo de Quentin">
                ...
                <li class="membre">
                    <img class="photo" src="../decoration/profil.jpg" alt="Photo de Alexandre">
